# M1 GATE DELIVERABLE MATRIX V4 (the corrected, semantically clean consolidation)
...
- EVIDENCE: iter019_p0_browser_result.json (SHA256 20CFC413E530E3F7C67760E884977F23970EEA6167E75E6159FEFE5CA8EC3FC9); iter019_p0_byte_audit.json (SHA256 4C29D22071E3E9CACD4744329B985EA534CFF1558C93F761AD1A8E89B2EF7A6B); iter019_era_validation_terrain_bnt.json (SHA256 D2D13D84558E337D8A3B8CA14DAFA8240A8B4A4B4B97AFA470F707141183F1DD)
...
- EVIDENCE: iter008b_winning_walk.json (SHA256 AAFD1A4EB0E459C27C597E5AEF96EEEA4B187F8F40EBA9D7AFA274AADFF80E11); iter019_era_validation_terrain_bnt.json (SHA256 D2D13D84558E337D8A3B8CA14DAFA8240A8B4A4B4B97AFA470F707141183F1DD); iter030_findings.json (SHA256 1104F3186116A98856438741D7F7439E25E6DEF578EAD6D2AA666812B3951207)
...
- EVIDENCE: iter030_findings.json (SHA256 1104F3186116A98856438741D7F7439E25E6DEF578EAD6D2AA666812B3951207); iter031_water_findings.json (SHA256 2F9BEF450E74E49886AF958B573F98C6E2C465D368F203587F6FCC82269C9EB8); iter030_page_result.json (SHA256 9B62AD3399F8D1D4E295862D5B065D580D5AB66E7DBA6655DD03FF3F20F8E39B)
...
- EVIDENCE: iter008b_winning_walk.json (SHA256 AAFD1A4EB0E459C27C597E5AEF96EEEA4B187F8F40EBA9D7AFA274AADFF80E11); iter020_material_decode_audit.json (SHA256 51898ABC09B15F6711634955928B8DF56FD35B4E2B2E17BDCAEB7543F223F458); iter030_findings.json (SHA256 1104F3186116A98856438741D7F7439E25E6DEF578EAD6D2AA666812B3951207); iter030_pcg_tile_census.json (SHA256 C3EB3C28CBEF2926E2A706F51D437D07C793C10D6A2CA74017FBD49F30E7F071)
...
- EVIDENCE: iter010_id_resolution.json (SHA256 ECA9B3588D99D1FF44CCC880B1EE82A245113DE1EB86357ED715C1F4AAF10D2A); iter011_payload_classification.json (SHA256 86271B9F08BF2057B846C3D21F10E1B0E385E9266575A5B47B4E91BA3BB0C2CE); iter030_page_result.json (SHA256 9B62AD3399F8D1D4E295862D5B065D580D5AB66E7DBA6655DD03FF3F20F8E39B)
...
- EVIDENCE: iter024_fx_id_0x3ea_Terrain_14.hlsl (SHA256 5AE4AF81B54A71E66E1F63A9718A984314D8FCB0763FDFFF19AE0C7EDF8516F1); iter024_blend_op_findings.json (SHA256 BA08FFD6F92B741AA76E095AA0EEE7066C51AB73CC5CFD8FB39134C4CC204126); iter030_findings.json (SHA256 1104F3186116A98856438741D7F7439E25E6DEF578EAD6D2AA666812B3951207); iter030_page_result.json (SHA256 9B62AD3399F8D1D4E295862D5B065D580D5AB66E7DBA6655DD03FF3F20F8E39B); AMENDMENT_ITER036_CLOSURE.json (SHA256 CBBEEEB9DF345FA804FE79011AF23D0F685E2CE51582B472BB3709BB3D590AE1); offline_rechecks.json (repair run 01_RAW) (SHA256 C80E65D62147E8DED2DE9C3D8EE028DE14BF619CB80C69BE71D30C8F0DEB4E32); fail_closed_gates.json (repair run 01_RAW) (SHA256 645C9FC472FA4E93445C539FB375EDADB4DF5890D59B03715F9E914E50C52775)
...
- EVIDENCE: iter032_findings.json (SHA256 AF8B900A3864612356A9575EE740F821BCEC1B7EB0FF65194E24A36E89B16866); iter032_rtti_chain.json (SHA256 176BCCC010F606C4808DF07024E5216AD6AE6DA3D8EBBE669E4ACA6B6F4F8F8A); iter032_re_dec_0083a7d0_vcl_parser.c (SHA256 F7E887DE9F27F0BD4E294C1CC7C5519018823A534E01DBD43F461B00D85D8A99); iter033_manifest.json (SHA256 DD59815206F35E795B6A9E6BE6A89C053DF17B9DF696CAB9658D0026179BBFAA)
...
- EVIDENCE: iter032_re_dec_0094b1d0_getmodel.c (SHA256 A0C2C9566EB40FFBE2EC0FD018E65F509FA643CAFD2AF6B4F0A7623C41168278); iter033_foliage_generator_census.json (SHA256 3AAFBF4874046395C63EA095B69FC172C4A908E22D0980448BD852416FA80E24); iter033_manifest.json (SHA256 DD59815206F35E795B6A9E6BE6A89C053DF17B9DF696CAB9658D0026179BBFAA); assets/foliage_glb/MANIFEST.json (SHA256 F299C6222917DA8859351D9BE4D2DF0D40F9C6BB7767378DFB22B18C4FFAD46C); offline_rechecks.json (repair run 01_RAW) (SHA256 C80E65D62147E8DED2DE9C3D8EE028DE14BF619CB80C69BE71D30C8F0DEB4E32)
...
- EVIDENCE: iter032_vcl_columns.json (SHA256 A62D9473D6D6D82C97595CEECCBCB915490F95A2B0F14750DBC03075A6526789); iter032_climate_id_space.json (SHA256 D7541E1D4F5F76FB6BC331FAD2E82FE10C8A64AF63019E6E85897C1614D01F51); iter032_tez_zoning_v3.json (SHA256 4892B189C6DE2F0783331AC305BDAAB4CAF4EA200BBF353141173DCA59806278)
...
- EVIDENCE: iter033_foliage_generator_census.json (SHA256 3AAFBF4874046395C63EA095B69FC172C4A908E22D0980448BD852416FA80E24); iter032_re_dec_0098fe00_grid_gen.c (SHA256 D02FC56AF76C1B1CDA2CC85B15736D683BD3D13B945D93D8BDFFA27245E2BD9E); iter032_re_dec_00990810_cell_records.c (SHA256 45339FE1862B967C093DA1823C1785A6C5967114BF1D9290A3182682249EBDD7); AMENDMENT_ITER035_ROWS10_11.json (SHA256 2B1FF548D1323BA46D1A8B533BF8BA943B5A508390637C632817D90B58254385); offline_rechecks.json (repair run 01_RAW) (SHA256 C80E65D62147E8DED2DE9C3D8EE028DE14BF619CB80C69BE71D30C8F0DEB4E32)
...
- EVIDENCE: iter033_rng_crosscheck.json (SHA256 F8056CD5EC3F7051DAF7799D7B3BAC92A7C9087A012CCD891BE61E70E6337F42); iter032_re_dec_0098cdf0_rng_seed.c (SHA256 D416A42236A26759C6E2F3DD7C8A8A426880D949FDB80AC1536DE477BC5F1221); iter032_re_dec_0098ce30_rng_next.c (SHA256 0A4AF5879DE70C1250BB3BD8D80A6CBC5D75E7DCC6E069EB406A7E4244CEB8F5); AMENDMENT_ITER035_ROWS10_11.json (SHA256 2B1FF548D1323BA46D1A8B533BF8BA943B5A508390637C632817D90B58254385); CONSTANT_ADDRESS_LOCK.json (repair run 03_STATIC) (SHA256 6F4A9A6ED2E26F18C59AEB88F571374B73647C80FE19F65D5F0B6466A8D80304); pc24_synthetic_measurement.json (THIS run, repo mirror docs/audits/PE_M1_GATE_V4_CORRECTION_R2_20260905_101327/01_RAW/) (SHA256 01B96D259F0FB09A6D724F8A4843938483D845736946FD73DEEBEBF4A74EA9DF)
...
- EVIDENCE: iter023_water_container_census.json (SHA256 5F2907E7777C2E18C84ED5C3A7A0CCA2FA49AB05E95D6AF3EE1660FFDFE707E2); iter031_water_findings.json (SHA256 2F9BEF450E74E49886AF958B573F98C6E2C465D368F203587F6FCC82269C9EB8); iter031_fx_id_0x3eb_Water.hlsl (SHA256 857DEA6EB601CDD130B0A1FA2FF1A38B419CAD7CB94A46521377E173B6449F5F)
...
- EVIDENCE: iter023_terrain_minheight_water.json (SHA256 314949A88AA8B8670E9555977B73F584FDDD343F6BA85F463AC54E276DDEA097); iter031_type6_census.json (SHA256 8D62122D9A6761F9B95303C959F286A7870515C0CCE1A32473C33AD466131322); iter031_water_findings.json (SHA256 2F9BEF450E74E49886AF958B573F98C6E2C465D368F203587F6FCC82269C9EB8)
...
- EVIDENCE: iter031_water_findings.json (SHA256 2F9BEF450E74E49886AF958B573F98C6E2C465D368F203587F6FCC82269C9EB8); iter023_terrain_minheight_water.json (SHA256 314949A88AA8B8670E9555977B73F584FDDD343F6BA85F463AC54E276DDEA097)
...
- EVIDENCE: iter031_water_fx_decode.json (SHA256 3FBD46EC6078E7EA103144C6C39462FFD2A899B81607E2799250A9E513D75941); iter031_fx_id_0x3eb_Water.hlsl (SHA256 857DEA6EB601CDD130B0A1FA2FF1A38B419CAD7CB94A46521377E173B6449F5F); iter023_water_container_census.json (SHA256 5F2907E7777C2E18C84ED5C3A7A0CCA2FA49AB05E95D6AF3EE1660FFDFE707E2)
...
- EVIDENCE: iter031_fx_id_0x3eb_Water.hlsl (SHA256 857DEA6EB601CDD130B0A1FA2FF1A38B419CAD7CB94A46521377E173B6449F5F); iter031_jul_fx_id_0x3eb_Water.hlsl (SHA256 857DEA6EB601CDD130B0A1FA2FF1A38B419CAD7CB94A46521377E173B6449F5F); iter031_jul_materials_compare.json (SHA256 4C4B8D7363A1B1B3D360C66EEAC5928803185960537B7D249A9329DE91549028)
...
- EVIDENCE: iter031_water_findings.json (SHA256 2F9BEF450E74E49886AF958B573F98C6E2C465D368F203587F6FCC82269C9EB8); iter031_water_fx_decode.json (SHA256 3FBD46EC6078E7EA103144C6C39462FFD2A899B81607E2799250A9E513D75941); iter031_materials_vfs_rec0025_25ArkLight.fx (SHA256 061C1E43FF5DAA65B9A9BE1E56591F1D3C5145B606792484403F70986F36D7E3)
...
- EVIDENCE: iter019_era_validation_terrain_bnt.json (SHA256 D2D13D84558E337D8A3B8CA14DAFA8240A8B4A4B4B97AFA470F707141183F1DD); iter010_id_resolution.json (SHA256 ECA9B3588D99D1FF44CCC880B1EE82A245113DE1EB86357ED715C1F4AAF10D2A); iter033_manifest.json (SHA256 DD59815206F35E795B6A9E6BE6A89C053DF17B9DF696CAB9658D0026179BBFAA)
...
- EVIDENCE: iter034_regression_sweep.json (SHA256 SEE 03_EVIDENCE (written at the iter034 session; recorded in the frozen matrix PART 2)); iter019_p0_browser_result.json (SHA256 20CFC413E530E3F7C67760E884977F23970EEA6167E75E6159FEFE5CA8EC3FC9); iter020_browser_result.json (SHA256 43AC2739BBBBC9282874B782D3AF79CF88761CB61E032E3549812C8A0D60370D); iter030_page_result.json (SHA256 9B62AD3399F8D1D4E295862D5B065D580D5AB66E7DBA6655DD03FF3F20F8E39B); iter031_water_findings.json (SHA256 2F9BEF450E74E49886AF958B573F98C6E2C465D368F203587F6FCC82269C9EB8); iter033_render_hashes.json (SHA256 37E0713EBBEC2C7DB61B0F3C01F674EB0CA751CB7A595E927F80B528C536D3BD); offline_rechecks.json (repair run 01_RAW) (SHA256 C80E65D62147E8DED2DE9C3D8EE028DE14BF619CB80C69BE71D30C8F0DEB4E32)

## THE ERA-BOUNDED REGISTRY - V4 (19 entries; v4_status per entry)

- **P1 (materials_confirmed)** - missing: the 65x65 climate byte grid (texture id 432502) | why: NOT in any local container (178-container census); the client fetch is LOCAL-ONLY (a miss halts init); patcher-delivered (ClientLoader FTP) | resume: a patcher-updated Textures.bnt of the era, or a runtime capture
  - era_statement: constant byte 0 -> palette A[0]=0x66DC6 (documented choice; the engine default for unmapped bytes is 0x66DC7); NO historical climate-truth claim
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P2 (materials_confirmed)** - missing: the 129x129 detail-selector grids (texture id 459344) | why: same delivery-channel verdict as P1 | resume: same as P1
  - era_statement: constant byte 0 -> the engine tables C[0]=D[0]=458791, E[0]=458792 (the ACTUAL engine entries for byte 0; mechanics CONFIRMED, input bounded)
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P3a (materials_confirmed)** - missing: the ArkHeightTree leaf recursion | why: the tree construction not RE'd (iter027 bound 1; leaves carry global-field samples, no tile linkage) | resume: the quadtree construction RE
  - era_statement: the leaf data chain preserved IN FORM (direct sample + clamp); the recursion is a labeled approximation
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P3b (materials_confirmed)** - missing: the cross-era georeferencing (field vs tiles) | why: UNPINNED: r=0.527 saturation (iter028); the MEASURED contradiction: field at engine addressing -130..-125 m vs tiles +16..+487 m (iter030) | resume: the 2010-era local terrain, or runtime tracing
  - era_statement: the ROW INPUT uses the TILES' OWN heights (backed by the measured contradiction - an honest choice, NOT a historical claim)
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P4 (materials_confirmed)** - missing: the per-session noise-table seeds | why: the engine seeds the manager RNG per-session (FUN_004058a0/00405920 Java-LCG decompiled); [P4] REDUCED TO THE SEED ONLY by iter036 (the draw construction is now exact) | resume: a runtime RNG capture
  - era_statement: FIXED-seed Java-LCG tables - deterministic reconstruction only
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P5 (materials_confirmed)** - missing: the accumulated leaf roughness at the historical scale | why: the CONFIRMED 12-slot formula evaluated on the tile grid at the 4-unit sample scale; the historical leaf size/depth rule not pinned | resume: the quadtree RE (same as P3a)
  - era_statement: formula CONFIRMED, scale DOCUMENTED
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P-WAVES (water_system)** - missing: waves01/02.tga (the plane wave textures) | why: name-registered (WAVES_01/02/03, type 1000) NOT in any local container | resume: a patched-era container or runtime capture
  - era_statement: SYNTHETIC normals - never claimed historical
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P-SKY (water_system)** - missing: sky0/1.tga (the reflection textures) | why: same census negative | resume: same as P-WAVES
  - era_statement: SYNTHETIC gradient - never claimed historical
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P-DATUM (water_system)** - missing: the water level in the TILE datum | why: the 10.0f constant is in the GLOBAL-FIELD datum; the field-vs-tile georef UNPINNED (same as P3b) | resume: the georef pin (P3b's closer)
  - era_statement: the page elevation = a demonstrative control (engine 10.0 field-datum; tile-datum UNPINNED; default 0.0 = the iter023 correlation)
  - v4_status: OPEN (not attempted in the repair run - the georef pin remains future work; current per the V3)
- **P-CLIMATE (foliage_system)** - missing: the per-location climate selection (which .vcl applies where) | why: the shared-selector hypothesis PLAUSIBLE-NOT-CONFIRMED (VCL ids vs palette ids DISJOINT; the .vcl fetch id source + type-id constant UNVERIFIED) | resume: the .vcl fetch-id RE + the cell-stream provider RE
  - era_statement: DOCUMENTED choice: climate index 0 - the page demonstrates the MECHANISM, not the historical placement
  - v4_status: OPEN (the cell-content origin remains open; the real-domain re-proof covers the sampler arithmetic only; current per the V3)
- **P-CELLSTREAM (foliage_system)** - missing: the historical cell byte-stream content | why: the DataSource/PatchSourceClient abstraction proven but the data origin NOT closed | resume: the cell-stream provider RE
  - era_statement: the local deterministic stand-in (round(col1) + the placement hash) is RECONSTRUCTION-ONLY
  - v4_status: OPEN (the cell-content origin remains open; the real-domain re-proof covers the sampler arithmetic only; current per the V3)
- **P-RNG-DIV (foliage_system)** - missing: the exact RNG normalization divisor | why: _DAT_00a7d7a8 reads 0.0 statically (runtime-initialized) | resume: runtime tracing (separate authorization)
  - era_statement: composed in V4 from the CONSTANT_ADDRESS_LOCK byte locks: the RNG normalization uses the BYTE-LOCKED operand 32767.0 f64 (_DAT_00a7d7a8, bytes 00 00 00 00 C0 FF DF 40, FDIV QWORD @0x0098CE5A) - rand01 = f32(r/32767.0) inclusive [0,1]; no candidate wording stands (the old registry era_statement was superseded per RETRACTIONS.md section 8)
  - v4_status: SUPERSEDED-LOCKED: _DAT_00a7d7a8 = 32767.0 f64 byte-locked (iter035; re-locked via the section map)
- **P-RNG-P3 (foliage_system)** - missing: p3 = *(impl+0x24) of the seed | why: UNVERIFIED; p2 = view band 10 STRONGLY_SUPPORTED not byte-pinned | resume: the impl-object RE
  - era_statement: p3 = 0 in the reconstruction - labeled
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P-POS-SCALE (foliage_system)** - missing: the u16->world position divisor | why: _DAT_00a8c758 reads 0.0 statically (runtime-initialized) | resume: runtime tracing
  - era_statement: composed in V4 from the CONSTANT_ADDRESS_LOCK byte locks: the u16->node position normalization uses the BYTE-LOCKED operand 65535.0 f64 (_DAT_00a8c758, bytes 00 00 00 00 E0 FF EF 40, FLD QWORD @0x0095B2BC) - nodeX/Y = f32(u16/65535.0) node-local fractions [0,1]; no candidate wording stands (the old registry era_statement was superseded per RETRACTIONS.md section 8)
  - v4_status: SUPERSEDED-LOCKED: _DAT_00a8c758 = 65535.0 f64 byte-locked (iter035; re-locked via the section map)
- **P-SCALE-FIELDS (foliage_system)** - missing: the col2/col3 -> scale min/max field mapping | why: the census reading + the impl+0x40/+0x44 direction STRONGLY_SUPPORTED (not byte-pinned) | resume: the impl-object RE
  - era_statement: a documented reading of the records - labeled
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P-WINDOW (foliage_system)** - missing: the historical generation window (grid extents) | why: the extents are settings-scaled, not statically pinneable | resume: the settings-source RE
  - era_statement: the window = the proven region - a demonstration window
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P-UNITS (foliage_system + water)** - missing: the NIF cm->render-m bridge | why: the NIF corpus is cm-native; the m->cm x100 engine scale CONFIRMED but the GLB cache bridge is a reconstruction convention | resume: the clean pesource NIF path
  - era_statement: the 0.01 bridge - CURRENT_RUNTIME_CALIBRATION
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **P-MATERIALS (foliage_system)** - missing: the per-model materials | why: the materials come from the GENERATED_CACHE GLBs (export source corpus UNVERIFIED at file level); the 0x3EC technique informs the lighting only | resume: the clean pesource NIF parser (a JS NIF reader over era Models.bnt)
  - era_statement: GENERATED_CACHE assets + fixed deterministic lights - an era-bounded approximation, NEVER claimed byte-faithful (the single iter037 witness chain is the exception, proven original-direct)
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)
- **ROTATION (foliage - RE-faithful absence, not a placeholder)** - missing: the rotation/variant derivation | why: NOT FOUND in the spawn loop (candidates FUN_0095ae20/FUN_0095b4f0 unread) | resume: the candidate-function RE
  - era_statement: identity rotation = the RE-faithful absence, recorded as such
  - v4_status: carried (open/era-bounded as in the ITER_048 basis; current per the V3)

## EXPLICITLY OPEN (the V4 known-open set - none solved here)

- the scrambled-texture FALSIFICATION (ledger ENTRY #3 - the witness must be used to falsify the U1 SEVERE cases) -- OPEN - explicitly NOT solved in the V4 package
...
- the actual x87 control word at chain-execution time (the PC/RC conditional model's SENSITIVITY is now measured on both domains - real 14,104/229,376 and synthetic 103,073/1,245,184, the latter double-confirmed by THIS run's re-measurement - but the ACTUAL client CW remains UNMEASURED; a runtime capture is the falsifier) -- OPEN - the V4-composed update of the V3 item (composed from the pc24_synthetic_measurement.json disposition)

## THIS RUN'S EVIDENCE (the V4-correction run; SHA-pinned in the run mirror)

- pc24_synthetic_measurement.json (01_RAW; SHA256 01B96D259F0FB09A6D724F8A4843938483D845736946FD73DEEBEBF4A74EA9DF): the run-side double measurement - 103,073/1,245,184 CONFIRMED
- semantic_gate_report.json (01_RAW): the semantic gate + the negative fixtures N1-N4 + the clean-copy PASS
- consistency_report_v4.json (01_RAW): the fail-closed consistency check
- pre_run_locks_verification.json (01_RAW): PRE_RUN_LOCKS_ALL_MATCH (21/21)
