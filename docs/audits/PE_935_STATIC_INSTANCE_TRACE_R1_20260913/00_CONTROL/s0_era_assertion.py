# -*- coding: utf-8 -*-
# PE_935_STATIC_INSTANCE_TRACE_R1_20260913 — S0 ERA ASSERTION (independent)
...
def main():
    ...
    # spot checks: known anchors from the previous run's S3 (same binary)
    spot = {}
    checks = [
        # (label, va, expected_file_offset or None, expected_section)
        ("string_Parameters_templates.vfs@0x00A86D30", 0x00A86D30, 6843696 - 6770688 + 6770688, ".rdata"),
        ("entry@0x0095DA11", 0x0095DA11, 5626385, ".text"),
        ("BNT2_string@0x00A9BF2C", 0x00A9BF2C, None, ".rdata"),
    ]
    ...
    result = {
        ...
        "measured": {
            ...
            "dll_characteristics": "0x%04X" % dll_chars,
            "aslr_enabled": aslr,
            "sections": [
