...
// function entry 0x67ccd0L (requested via site 0x67ce5f)

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __thiscall FUN_0067ccd0(int param_1,undefined4 param_2,char param_3)
  ...
  if (param_3 != '\0') {
    ...
    *(void **)(param_1 + 8) = pvVar6;
    ...
    if ((!bVar7) && (pvStack_8c != (void *)0x0)) {
      ppvStack_110 = (void **)0x67d0d7;
      FUN_00890d30();
      if (pvStack_8c != (void *)0x0) {
        ppvStack_110 = (void **)0x67d0f2;
