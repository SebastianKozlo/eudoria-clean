# -*- coding: utf-8 -*-
# PE_935_ATTRIBUTE_ORIGIN_SEAM_R1_20260913 — S0 ERA ASSERTION (independent)
# STATIC-ONLY. Fail-closed on BOTH inputs: Entropia.exe + templates.vfs.
# Mismatch -> exit 1 (HARD STOP), no downstream work.
# pe_core.py copied from PE_935_RECEIVER_PROVENANCE_CORRECTIONS_R1_20260913
# (SHA256 F8FBD0EECBFCA4AD1F16810239A2D44FF5CF36A104AF2CA8B9101E9F686801CC).
...
def main():
    ...
    checks = [
        ...
        ("param_mgr_singleton_DAT_00BA12E8", 0x00BA12E8, None, ".data"),
        ("value_ctor_candidate_FUN_0085B1B0", 0x0085B1B0, None, ".text"),
        ("vtable_value_candidate_0x00A91E4C", 0x00A91E4C, None, ".rdata"),
        ("mgr_ctor_FUN_008550C0", 0x008550C0, None, ".text"),
        ("resolver_FUN_008544D0", 0x008544D0, None, ".text"),
    ]
    ...
    result = {
        ...
        "declared_by_master_not_measured": {
            "repo_base_sha": "5d0edde5863795d6eefd8bb11989e8edb7b28546",
            "note": ("BASE_SHA of eudoria-clean declared by PE-MASTER in the contract; "
                     "this run performs NO git operations (hard stop), so repo SHA is "
                     "recorded as master declaration, not own measurement."),
        },
