...
| NiArkAnimation binary records | **DECODED (ITER-6/7)**: G3B 33B record + embedded event-name registry (morph: left/right, sound:hit_01-03, start_usetool:*) connecting behaviors to vertex morphs BY NAME | G3D internal record SEMANTICS (role of class 01/02/03 flags; 348 blocks, index lists — the size formula `u3_byte1×5` was RETRACTED-from-suspicion: CONFIRMED CORRECT 348/348 in ITER-27); G3D/G9 exact string framing |
